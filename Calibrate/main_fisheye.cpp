...
int main()
{
	...
	CHECK(cal.save_chessboard(new cv::VideoCapture("/home/burak/opencv-3.4.3/samples/data/left%02d.jpg"), 0)); // re-read from saved images
	...
	{
		std::string filename = "/home/burak/opencv-3.4.3/samples/data/left0" + std::to_string(i + 1) + ".jpg";
